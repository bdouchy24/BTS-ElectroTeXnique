...
\begin{table}
\caption{Distribution des électrons dans les orbitales atomiques par sous-couche électronique\label{tab:distribution_electronique}}

\resizebox{\linewidth}{!}{ %adapte le tableau à la largeur de ligne en gardant les proportions (ne fonctionne pas avec tabularx)

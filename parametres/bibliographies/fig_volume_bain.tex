...
% Text Node
\draw (501,156) node [anchor=north west][inner sep=0.75pt]   [align=left] {Volume 2};
% Text Node
\draw (576,232) node [anchor=north west][inner sep=0.75pt]   [align=left] {Volume 1};
% Text Node
\draw (169,236) node [anchor=north west][inner sep=0.75pt]   [align=left] {Volume 2};
% Text Node
\draw (249,111) node [anchor=north west][inner sep=0.75pt]   [align=left] {Volume 1};
% Text Node
\draw (358,157) node [anchor=north west][inner sep=0.75pt]   [align=left] {Hors volume};
% Text Node
\draw (33,107) node [anchor=north west][inner sep=0.75pt]   [align=left] {Hors volume};
% Text Node
\draw (249,226) node [anchor=north west][inner sep=0.75pt]   [align=left] {Volume 0};
% Text Node
\draw (181,121) node [anchor=north west][inner sep=0.75pt]   [align=left] {\SI{0,6}{\meter}};
% Text Node
\draw (576,282) node [anchor=north west][inner sep=0.75pt]   [align=left] {Volume 0};
% Text Node
\draw (516,116) node [anchor=north west][inner sep=0.75pt]   [align=left] {\SI{0,6}{\meter}};
% Text Node
\draw (600,182) node [anchor=north west][inner sep=0.75pt]   [align=left] {\SI{2,25}{\meter}};
% Text Node
\draw (456,321) node [anchor=north west][inner sep=0.75pt]   [align=left] {volume caché};

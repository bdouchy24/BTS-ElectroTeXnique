...
%--------------------------------------
	...
	\begin{tikzpicture}[remember picture, overlay]
		...
		\draw (5,-12.5) node [right, opacity=0.7] {\sffamily\textls[150]{\Huge\textbf{\color{bleulogo}Physique -- Chimie}}}; %intitulé de la matière
		\draw (20,-14.5) node [left, opacity=0.7] {\sffamily\textls[150]{\Huge\textbf{\color{bleulogo}Pré-requis}}}; %intitulé du cours

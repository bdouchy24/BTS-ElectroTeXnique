...
\pgfcircdeclarebipolescaled{sources}
{
    \savedanchor{\centerprim}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=-\ctikzvalof{bipoles/oosourcetrans/circleoffset}\pgf@circ@scaled@Rlen
            \pgf@y=0pt
    ...
    \savedanchor{\centersec}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=-\ctikzvalof{bipoles/oosourcetrans/circleoffset}\pgf@circ@scaled@Rlen
            \pgfpointpolar{0}{.5\pgf@circ@scaled@Rlen}
            \pgf@y=-\pgf@y
            \pgf@x=-\pgf@x
    }
    \anchor{centersec}{
    ...
    \anchor{prim1}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/circlesize}\pgf@circ@scaled@Rlen
            \pgfpointadd{\centerprim}{\pgfpointpolar{135}{.5\pgf@circ@scaled@Rlen}}
    }
    \anchor{prim2}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/circlesize}\pgf@circ@scaled@Rlen
            \pgfpointadd{\centerprim}{\pgfpointpolar{180}{.5\pgf@circ@scaled@Rlen}}
    }
    \anchor{prim3}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/circlesize}\pgf@circ@scaled@Rlen
	...
	\anchor{prim1'}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/circlesize}\pgf@circ@scaled@Rlen
            \pgfpointadd{\centerprim}{\pgfpointpolar{150}{.5\pgf@circ@scaled@Rlen}}
    }
 	\anchor{prim2'}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/oosourcetrans/circlesize}\pgf@circ@scaled@Rlen
    ...
    \anchor{sec1}{
            ...
            \pgfpointadd{\centersec}{\pgfpointpolar{75}{.55\pgf@circ@scaled@Rlen}}
    }
    \anchor{sec2}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/ooosource/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/ooosource/circlesize}\pgf@circ@scaled@Rlen
            \pgfpointadd{\centersec}{\pgfpointpolar{25}{.55\pgf@circ@scaled@Rlen}}
    }
    \anchor{sec3}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/ooosource/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/ooosource/circlesize}\pgf@circ@scaled@Rlen
    ...
    \anchor{sec1'}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/ooosource/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/ooosource/circlesize}\pgf@circ@scaled@Rlen
            \pgfpointadd{\centersec}{\pgfpointpolar{30}{.55\pgf@circ@scaled@Rlen}}
    }
    \anchor{sec2'}{
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/ooosource/height}\pgf@circ@Rlen
            \pgf@circ@scaled@Rlen=\ctikzvalof{bipoles/ooosource/circlesize}\pgf@circ@scaled@Rlen
s            \pgfpointadd{\centersec}{\pgfpointpolar{-30}{.55\pgf@circ@scaled@Rlen}}
    }
}

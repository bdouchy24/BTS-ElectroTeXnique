...
%--------------------------------------
	...
	\usepackage{xstring, multirow, booktabs, makecell, longtable, arydshln, xltabular} %gestion fine des tableaux (sans \ltablex !)
...
\newcommand{\circref}[1]{\CircledText{\small\textbf{\ref{#1}}} : } %référence des pastilles
	...
	\renewcommand*{\overrightarrow}[1]{\vbox{\halign{##\cr %écriture des vecteurs sans que la flèche touche les lettres
 	\tiny\rightarrowfill\cr\noalign{\nointerlineskip\vskip1pt} 
  	...
  	\LetLtxMacro{\OldSqrt}{\sqrt} %grosse prise de tête pour que la nième racine de trucmuche s'aligne correctement suite à un clash avec le package newtxmath

...
\Invnumtrue %défini la booléenne Invnum comme vrai -> inversion des numéros de pages
	...
	\let\null\clearpage %supprime une page blanche en cas double page avant le corps du texte
...
\Invnumfalse %défini la booléenne Invnum comme faux
	...
	\input{chap_A_addendum_dangers_electricite}
...
\backmatter
	...
	\nocite{AFPA2000, BourgeoisCogniel2005, CNED:SLT2003, Juguet2017, LycéeJean-Caillaud:PRE2013, Timin2003chap2, WildiSybille2014}

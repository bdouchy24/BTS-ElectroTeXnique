...
%--------------------------------------
	...
	\begin{tikzpicture}[remember picture, overlay]
		...
		%\draw (5,-12.5) node [right, opacity=0.7] {\sffamily\textls[150]{\Huge\textbf{\color{bleulogo}\textsc{Matière ligne1}}}}; 	%ligne 1 long intitulé de la matière
		\draw (5,-14) node [right, opacity=0.7] {\sffamily\textls[150]{\Huge\textbf{\color{bleulogo}Matière}}}; %intitulé de la matière
		\draw (20,-16) node [left, opacity=0.7] {\sffamily\textls[150]{\Huge\textbf{\color{bleulogo}Cours}}}; %intitulé du cours
		%\draw (20,-17.5) node [left, opacity=0.7] {\sffamily\textls[150]{\Huge\textbf{\color{bleulogo}\textsc{Cours ligne1}}}};  %ligne 1 long intitulé du cours

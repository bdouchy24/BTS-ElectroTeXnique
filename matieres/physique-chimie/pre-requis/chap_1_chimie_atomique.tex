...
\input{../../../parametres/preambule/preambule} %à redéfinir une fois le cours entamé le chemin ne sera pas le même selon les cours !
...
\begin{figure}[h!] %insertion d'une figure avec imposition de l'emplacement vertical (Here!)
	...
	\begin{tikzpicture} %environnement de dessin avec repère cartésien aux origines au centre du schéma		
		...
		\draw[->,>=stealth, thick, rounded corners=4pt] (-4,0) |- (-2,-1);
		\draw[>=stealth, thick, rounded corners=4pt] (-3,-1) -| (0,0);
...
\begin{description} %environnement de liste descriptive

	\item[Matière]\hfill %occupation la ligne horizontale pour forcer le passage à la ligne des éléments suivants
	...
	\item[Molécule]\hfill %occupation la ligne horizontale pour forcer le passage à la ligne des éléments suivants
		\begin{itemize}
	...
	\item[Atome]\hfill %occupation la ligne horizontale pour forcer le passage à la ligne des éléments suivants
		\begin{itemize}
	...
	\item[Proton]\hfill %occupation la ligne horizontale pour forcer le passage à la ligne des éléments suivants
		\begin{itemize}
	...
	\item[Neutron]\hfill %occupation la ligne horizontale pour forcer le passage à la ligne des éléments suivants
		\begin{itemize}
	...
	\item[\'Electron]\hfill %occupation la ligne horizontale pour forcer le passage à la ligne des éléments suivants
		\begin{itemize}
...
\pagebreak
\input{tab_description_nombres_quantiques}
\pagebreak
...
L'atome d'aluminium possède trois électrons de valence sur sa dernière couche électronique $3s^{\Circled{2}}\overset{\overset{+}{~}}{~}3p^{\Circled{1}}$. %symbole + au-dessus
